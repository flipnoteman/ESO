...
use crate::asset_handling::mesh::MeshData;
...
pub fn cube_indexed(size: f32) -> MeshData {
    let h = size * 0.5; // half-extent
...
pub fn cube_stripped(size: f32) -> MeshData {
    let h = size * 0.5;
...
pub fn cuboid(x_len: f32, y_len: f32, z_len: f32) -> MeshData {
...
pub fn plane(x_len: f32, y_len: f32) -> MeshData {
    let x = x_len * 0.5;
    let y = y_len * 0.5;
...
pub fn subdivided_plane(x_len: f32, y_len: f32, subdivs_x: usize, subdivs_y: usize) -> MeshData {
    // half-extents
